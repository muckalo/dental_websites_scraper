...
from app.config.cfg_kent_express import CLIENT_CRED_LST, MAX_THREADS, DRIVER
from app.config.config import logo_img_link_ke, product_name_color, price_color, btn_color
...
class KentExpress:
    ...
    def login_to_website(self, driver, st, t_name, q, q_item, done_q_lst, failed_q_lst, items_for_scraping_len, script_name):
        ...
        """ Login """
        website_url = 'https://www.kentexpress.co.uk/'
    ...
    def get_product_data(self, driver, product_id, product_url):
        ...
        product_dict = {
            ...
            'logo_img_link': logo_img_link_ke,
